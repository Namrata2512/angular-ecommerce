...
name1:any;
  ...
  public submit()
  {
    ...
    // this.regiform.controls['id'].markAsTouched();
    // this.regiform.controls['name'].markAsTouched();
    // this.regiform.controls['mobile'].markAsTouched();
    // this.regiform.controls['email'].markAsTouched();
    // this.regiform.controls['address'].markAsTouched();
    // this.regiform.controls['pass'].markAsTouched();
